...
## 1. Illustration
- This is the source code for the paper [Arc-support Line Segments Revisited: An Efficient and High-quality Ellipse Detection](https://arxiv.org/abs/1810.03243v3).  
...
@article{Lu2018Highquality,
  ...
  journal   = {arXiv preprint arXiv:1810.03243v3},
  Year = {2018}
}
```
